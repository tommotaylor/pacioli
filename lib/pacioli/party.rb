module Pacioli
  class Party < ActiveRecord::Base
    ...
    def self.for(party)
      Party.where(partyable_type: party.class.name, partyable_id: party.id).includes(:transactions).first || Party.create!(partyable_type: party.class.name, partyable_id: party.id, type: "Pacioli::Debtor") # By default creates a debtor
    end
